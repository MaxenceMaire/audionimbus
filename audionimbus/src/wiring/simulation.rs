use super::{
    Allocate, DirectFrame, DirectStep, ReflectionsFrame, ReflectionsOutput, ReflectionsReverbFrame,
    ReflectionsReverbOutput, ReflectionsReverbStep, ReflectionsStep, SimulationRunner,
};
...
where
    T: RayTracer,
{
    pub fn spawn_pathing(&self) -> PathingSimulation {
        // TODO: implement pathing simulation builder.
        todo!()
    }
}

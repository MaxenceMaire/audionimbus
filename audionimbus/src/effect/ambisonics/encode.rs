//! Encoding point sources to Ambisonics format.
...
/// const NUM_CHANNELS: usize = num_ambisonics_channels(1) as usize; // 4 channels (1st order)
/// let mut output = vec![0.0; NUM_CHANNELS * FRAME_SIZE];

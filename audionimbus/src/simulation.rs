...
pub struct SimulationSettings<'a> {
    ...
    /// The maximum Ambisonic order of impulse responses generated by simulations.
...
impl From<SimulationSettings<'_>> for audionimbus_sys::IPLSimulationSettings {
    fn from(settings: SimulationSettings) -> Self {
        ...
        let mut max_num_occlusion_samples = 0;
        ...
        let mut max_num_rays = 0;
        let mut num_diffuse_samples = 0;
        ...
        let mut num_visibility_samples = 0;

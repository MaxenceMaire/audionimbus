...
```toml
[dependencies]
audionimbus = { version = "0.15.0", features = ["auto-install", "bevy"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.15.0", features = ["auto-install", "wwise"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.15.0", features = ["fmod"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.15.0", features = ["wwise"] }
```

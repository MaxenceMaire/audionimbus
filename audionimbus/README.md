...
```toml
[dependencies]
audionimbus = { version = "0.9.0", features = ["auto-install"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.9.0", features = ["auto-install", "fmod"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.9.0", features = ["auto-install", "wwise"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.9.0", features = ["fmod"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.9.0", features = ["wwise"] }
```

...
```toml
[dependencies]
audionimbus = { version = "0.8.2", features = ["auto-install"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.8.2", features = ["auto-install", "fmod"] }
```
...
```toml
[dependencies]
audionimbus = { version = "0.8.2", features = ["auto-install", "wwise"] }
```

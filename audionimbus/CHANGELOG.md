...
- `BinauralEffectSettings`, `BinauralEffectParams`, `Spatialization`, `VirtualSurroundEffectSettings` and `VirtualSurroundEffectParams` now take the HRTF handle by value instead of by reference.
...
- Implement `Clone` for `Spatialization`, `PathEffectSettings`, `VirtualSurroundEffectSettings` and `VirtualSurroundEffectParams`.

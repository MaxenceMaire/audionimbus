...
```toml
[dependencies]
audionimbus-sys = { version = "4.8.2-rc.2", features = ["auto-install"] }
```
...
```toml
[dependencies]
audionimbus-sys = { version = "4.8.2-rc.2", features = ["auto-install", "fmod"] }
```
...
```toml
[dependencies]
audionimbus-sys = { version = "4.8.2-rc.2", features = ["auto-install", "wwise"] }
```
...
```toml
[dependencies]
audionimbus-sys = { version = "4.8.2-rc.2", features = ["fmod"] }
```
...
```toml
[dependencies]
audionimbus-sys = { version = "4.8.2-rc.2", features = ["wwise"] }
```
